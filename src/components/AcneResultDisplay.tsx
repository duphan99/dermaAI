...
import type { AcneAnalysisResult, AcneTreatmentPlan, InClinicProcedure, MachineInfo, CosmeticInfo } from '../types';
...
const EditableList: React.FC<{
    items: string[];
    planKey: keyof AcneTreatmentPlan;
        ...
        <div className="animate-fade-in space-y-6">
            ...
            <div className="p-5 bg-white border border-slate-200 rounded-2xl">
                ...
                <div className="space-y-3">
                    ...
                    <AccordionSection
                        title="Lời khuyên về lối sống & Chế độ ăn"
                        ...
                        isOpen={openSection === 'lifestyleAdvice'}
                        onToggle={() => toggleSection('lifestyleAdvice')}
                    >
                        <EditableList
                            items={editablePlan.lifestyleAdvice}
                            planKey="lifestyleAdvice"
                            onPlanChange={onPlanChange}
                            currentPlan={editablePlan}
