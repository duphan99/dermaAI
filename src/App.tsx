...
const App: React.FC = () => {
  ...
  const handleSendZalo = async () => {
    ...
    // FIX: Replaced onTagsChange with individual handlers to match TagInput component props.
                ...
                <div className="space-y-4 p-4 border border-gray-200 rounded-2xl bg-slate-50/80">
                  ...
                  <div className="space-y-2">
                   ...
                   <TagInput 
                    ...
                    onTagAdd={handleCosmeticAdd}
                    onTagRemove={handleCosmeticRemove}
                    onTagUpdate={handleCosmeticUpdate}
                  ...
                  <TagInput 
                    ...
                    onTagAdd={handleMachineAdd}
                    onTagRemove={handleMachineRemove}
                    onTagUpdate={handleMachineUpdate}
