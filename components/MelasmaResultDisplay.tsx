...
import type { MelasmaAnalysisResult, MelasmaTreatmentPlan, InClinicProcedure, MachineInfo, CosmeticInfo, ExpertAdvice } from '../types';
...
export const MelasmaResultDisplay: React.FC<MelasmaResultDisplayProps> = ({ result, editablePlan, onPlanChange, availableMachines, availableCosmetics }) => {
    ...
    return (
        <div className="animate-fade-in space-y-6">
            ...
            <div className="p-5 bg-white border border-slate-200 rounded-2xl">
                <h3 className="text-lg md:text-xl font-bold text-slate-800 mb-4">Phác đồ điều trị nám (Có thể chỉnh sửa)</h3>
                <div className="space-y-3">
                    <AccordionSection
                    ...
                    >
                        <EditableList
                            ...
                            onItemsChange={(newItems) => onPlanChange({ ...editablePlan, sunProtectionAdvice: newItems })}
