...
import type { AcneAnalysisResult, AcneTreatmentPlan, InClinicProcedure, MachineInfo, CosmeticInfo, ExpertAdvice } from '../types';
...
const EditableProcedures: React.FC<{
    ...
    onPlanChange: (newPlan: AcneTreatmentPlan) => void;
    currentPlan: AcneTreatmentPlan;
...
interface AcneResultDisplayProps {
    result: AcneAnalysisResult;
    editablePlan: AcneTreatmentPlan;
    onPlanChange: (plan: AcneTreatmentPlan) => void;
    availableMachines: MachineInfo[];
    availableCosmetics: CosmeticInfo[];
}

export const AcneResultDisplay: React.FC<AcneResultDisplayProps> = ({ result, editablePlan, onPlanChange, availableMachines, availableCosmetics }) => {
    ...
    return (
        <div className="animate-fade-in space-y-6">
            ...
            <div className="p-5 bg-white border border-slate-200 rounded-2xl">
                <h3 className="text-lg md:text-xl font-bold text-slate-800 mb-4">Phác đồ điều trị mụn (Có thể chỉnh sửa)</h3>
                <div className="space-y-3">
                    <AccordionSection
                    ...
                    >
                        <EditableList
                            ...
                            onItemsChange={(newItems) => onPlanChange({ ...editablePlan, homeCareRoutine: newItems })}
